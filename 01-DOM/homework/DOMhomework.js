...
let elemento = document.getElementById('createdBy');
elemento.innerHTML = 'Aplicación creada por Rogelio';
...
function buildToDo(todo, index) {
    ...
    toDoBtn.setAttribute('type', 'checkbox');
...
function displayToDos() {
    ...
    let llamar = buildToDos(toDoItems);
    llamar.map(x => toDoContainer.appendChild(x));
...
function addToDo() {
    ...
    toDoItems.push(toDo);
    let SetText = document.getElementById('toDoInput').value;
    SetText.innerHTML = '';
    displayToDos();
}
